...
[View or download sample code](https://github.com/nooberfsh/iris/tree/master/_examples/websocket).
...
* import the `"github.com/nooberfsh/iris/websocket"`
...
```go
import "github.com/nooberfsh/iris/websocket"
```
