...
import (
	...
	"github.com/nooberfsh/iris/core/router/macro"
)
...
type Party interface {
	...
	//
	// Learn more at:  https://github.com/nooberfsh/iris/tree/master/_examples/routing/dynamic-path
	Macros() *macro.Map
	...
	// Returns this Party.
	//
	// Example: https://github.com/nooberfsh/iris/tree/master/_examples/mvc/middleware/without-ctx-next
	...
	//
	//
	// Example: https://github.com/nooberfsh/iris/tree/master/_examples/file-server/embedding-gziped-files-into-app
