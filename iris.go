...
import (
	...
	"github.com/nooberfsh/iris/core/maintenance"
	"github.com/nooberfsh/iris/core/netutil"
	"github.com/nooberfsh/iris/core/router"
	// handlerconv conversions
	"github.com/nooberfsh/iris/core/handlerconv"
	// cache conversions
	"github.com/nooberfsh/iris/cache"
	// view
	"github.com/nooberfsh/iris/view"
	// middleware used in Default method

	requestLogger "github.com/nooberfsh/iris/middleware/logger"
...
//
// Example: https://github.com/nooberfsh/iris/tree/master/_examples/subdomains/redirect
...
var (
	...
	//
	//
	// Examples: https://github.com/nooberfsh/iris/tree/master/_examples/file-server
	...
	//
	// Examples can be found at: https://github.com/nooberfsh/iris/tree/master/_examples/#caching
	Cache = cache.Handler
	...
	// Use this, which is a shortcut of the, `chache#Cache304` instead of the "github.com/nooberfsh/iris/cache" or iris.Cache
...
//
// Example: https://github.com/nooberfsh/iris/tree/master/_examples/file-server/single-page-application
...
// https://github.com/nooberfsh/iris/blob/master/_examples/http-listening/notify-on-shutdown/main.go
