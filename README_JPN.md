...
[皆様の声](#支援)をご覧ください。このレポジトリを[Star](https://github.com/nooberfsh/iris/stargazers)し、[最新情報](https://facebook.com/iris.framework)を受け取りましょう。
...
- [HISTORY](HISTORY.md#sat-11-august-2018--v1070)ファイルはあなたの友人です。このファイルには、機能に関する最新の情報や変更点が記載されています。
- バグを発見しましたか？[github issues](https://github.com/nooberfsh/iris/issues)に投稿をお願い致します。
...
[全貢献者リスト](https://github.com/nooberfsh/iris/graphs/contributors)
...
- より詳しく知るために[godocs](https://godoc.org/github.com/nooberfsh/iris)を読む
...
> 似たようなものを開発しましたか？ [私たちにも教えてください！](https://github.com/nooberfsh/iris/pulls)
